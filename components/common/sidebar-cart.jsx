                ...
                <div className={`sidebar-action sidebar-cart ${openCart ? 'cart-open' : ''}`}>
                    <div className='cartmini__wrapper'>
                        ...
                        <div className="cartmini__close">
                            <button type="button" className="cartmini__close-btn" onClick={() => setOpenCart(false)}><i className="fal fa-times"></i></button>
                        </div>
                            ...
                            {cartProducts.length >= 1 && <>
                                    ...
                                    <ul>
                                        {cartProducts.map((item, index) => (
                                            <li key={index}>
                                                ...
                                                <span className="cartmini__del" onClick={() => dispatch(remove_cart_product(item))}><i className="fal fa-times"></i></span>
                                            </li>
                                        ))}
                                    </ul>
                                </div>
                                <div className="cartmini__checkout">
                                    ...
                                    <div className="cartmini__checkout-btn">
                                        <Link href="/cart"><a className="bd-fill__btn w-100">View cart</a></Link>
